    ...
    <main className="container">
      ...
      <div className="about-section">
        ...
        <div className="text-container">
          ...
          <p className="about">
            Angel Sara Mathew Bsc Creative Computing graduate. Passionate about making videos and websites and designing, crafting, writing stories, and taking photos and videos.
          </p>
        </div>
      </div>

      <div className="buttons">
        <button className="sphere" onClick={() => document.getElementById('projects-section').scrollInto_View({ behavior:'smooth'})} title="Click me">University Projects</button>
        <button className="sphere" onClick={() => document.getElementById('events-section').scrollInto_View({ behavior:'smooth'})} title="Click me">University Events</button>
        <button className="sphere" onClick={() => document.getElementById('personalworks-section').scrollInto_View({ behavior:'smooth'})} title="Click me">Personal Works</button>
        <button className="sphere" onClick={() => document.getElementById('certificates-section').scrollInto_View({ behavior:'smooth'})} title="Click me">Certificates</button>
      </div>
      ...
      <section className="events">
        ...
        <div id="events-section">
          ...
          <div className='imgcard'>
            <img src="/assets/universityevents/gdg_event/GDG event.jpeg" alt="GDG"/>
          </div>
        </div>
      </section>
        ...
        <div>
          <div className="story-container">
            ...
            <div className="story-content-overlay">
              ...
              <a href="/assets/personalwork/stories/Marvellous life of a parrot.pdf" target="_blank" rel="noopener noreferrer" title="Click to read the story" className='pdf-link'>
                <div className='pdf-box'><span>Read Story</span></div>
              </a>
            </div>
          </div>
          <div className="story-container">
            ...
            <div className="story-content-overlay">
              ...
              <a href="/assets/personalwork/stories/story_ valiant girl.pdf" target="_blank" rel="noopener noreferrer" title="Click to read the story" className='pdf-link'>
                <div className='pdf-box'><span>Read Story</span></div>
              </a>
            </div>
          </div>
          <div className="story-container">
            ...
            <div className="story-content-overlay">
              ...
              <a href="/assets/personalwork/stories/Story_ Poppy.pdf" target="_blank" rel="noopener noreferrer" title="Click to read the story" className='pdf-link'>
                <div className='pdf-box'><span>Read Story</span></div>
              </a>
            </div>
          </div>
          <div className="story-container">
            ...
            <div className="story-content-overlay">
              ...
              <a href="/assets/personalwork/stories/Story_golden pheasant.pdf" target="_blank" rel="noopener noreferrer" title="Click to read the story" className='pdf-link'>
                <div className='pdf-box'><span>Read Story</span></div>
              </a>
            </div>
          </div>
